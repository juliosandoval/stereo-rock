...
import com.escom.adoo.Controlador.UsersController;
...
public class AddUserServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String username = request.getParameter("last_name");
        ...
        if (add.addNewUser(username, password, last,name, mail, privilegio)) {
